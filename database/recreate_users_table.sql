-- users 테이블 완전 재생성 (AUTO_INCREMENT INT)
USE summariq;
...
-- 9. 결과 확인
SELECT 'Users table recreated successfully with AUTO_INCREMENT INT starting from 0!' AS message;
DESCRIBE users;
